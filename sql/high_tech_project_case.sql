...
CREATE TABLE `project_case` (
  ...
  `leiji` float DEFAULT NULL,
  `project_name` varchar(45) COLLATE utf8_danish_ci DEFAULT NULL,
  `money` float DEFAULT NULL,
  `lx_time` varchar(45) COLLATE utf8_danish_ci DEFAULT NULL,
  `cailiao` varchar(45) COLLATE utf8_danish_ci DEFAULT NULL,
  `content` varchar(45) COLLATE utf8_danish_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
